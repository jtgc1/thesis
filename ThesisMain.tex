...
\input{macros/style}	%If thesis not matching style change here
\input{macros/use_packages} % all usepackage commands and newcommands in this file
...
\newpage
	...
	\include{chapters/3/related_literature}
