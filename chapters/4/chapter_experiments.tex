...
The simulated dataset contains $\valsize$ samples distributed equally among the four source configurations: both, bottom-only, top-only, and neither.
...
Each method is tuned on a training subset of $\trainsize$ synthetic data samples. The tuning procedure for each method is described below.
